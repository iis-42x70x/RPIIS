...
- Реализовала алгоритм решения задачи 2.5 [руководства](https://drive.google.com/file/d/1-rSQZex8jW-2DlY2kko18gU1oUAtEGHl/view) на языке программирования C++ с использованием матрицы смежности.
- Проверила данный алгоритм на корректность при помощи придуманного мной теста.
## Использованные источники
1. Свободная энциклопедия "Википедия" \[Электронный ресурс\]. — Режим доступа: https://ru.wikipedia.org/wiki/Граф_(математика)
2. Видео-урок "Теория графов. Хранение графа: матрица смежности. Центр онлайн-обучения «Фоксфорд»" \[Электронный ресурс\]. — Режим доступа: https://youtu.be/TLV2akXrAXE?si=H6aPu9Bb06M75838
3. Видео-урок "Графы.Вступление. Виды графов,степень вершин, ориентированный граф"  \[Электронный ресурс\]. — Режим доступа: https://youtu.be/jGIV5RPj420?si=1wQLW9LZditPcTnf

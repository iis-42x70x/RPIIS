...
```
```
Перейдите в директорию, где находиться скрипт, полсе чего пропишите в cmd <название скрипта с расширением> <путь к директории, котрую нужно проверить>
```
* Linux(sh файл):
```
...
```
```
Перейдите в директорию, где находиться скрипт, полсе чего пропишите в Ubuntu ./<название скрипта с расширением> <путь к директории, котрую нужно проверить>
```
## Контрольные вопросы:  

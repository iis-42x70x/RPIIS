...
Создать исполняющие файлы форматов .bat и .sh, выполняющие
соответствующее варианту действие.  
Вариант-85: На вход пакетному файлу приходит число (как 
параметр пакетного файла). Если число отрицательное, то выводим 
сегдняшнюю дату в формате mm-dd-yyyy, если число положительное 
и четное, то выводим текущую дату в формате mm/dd/yyyy, если 
число положительное и нечетное то выводим текущий месяц.

...
- Сбалансированное дерево - дерево, в котором ни один лист не находится намного дальше от корня, чем любой другой лист.
- Узел - каждый элемент дерева.
- Потомок (дочерний узел) - узел, который является потомком любого узла.
- Родитель (узел-родитель, узел-предок) - узел, который является предшественником любого узла.
...
- "Братья" - узлы, которые имеют одного и того же родителя.

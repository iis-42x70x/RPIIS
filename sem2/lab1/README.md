...
**Объединение декартовых деревьев**

![image](5.png)

**Пересечение декартовых деревьев**
...
## Источники
1. https://habr.com/ru/articles/101818/
2. https://neerc.ifmo.ru/wiki/index.php?title=%D0%94%D0%B5%D0%BA%D0%B0%D1%80%D1%82%D0%BE%D0%B2%D0%BE_%D0%B4%D0%B5%D1%80%D0%B5%D0%B2%D0%BE
3. https://ru.wikipedia.org/wiki/%D0%94%D0%B5%D0%BA%D0%B0%D1%80%D1%82%D0%BE%D0%B2%D0%BE_%D0%B4%D0%B5%D1%80%D0%B5%D0%B2%D0%BE
4. http://e-maxx.ru/algo/treap
   
## Вывод

Я разработала программу на C++, реализующую декартово дерево (Treap) с основными операциями: вставкой, удалением, поиском, объединением и пересечением. Программа имеет удобное консольное меню для взаимодействия с пользователем. Все операции работают корректно, сохраняя свойства бинарного дерева поиска и кучи. Код структурирован и легко расширяем.

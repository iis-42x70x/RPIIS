...
* Поиск суммы на отрезке с границами (2, 3) 
...
## Источники
[Дерево отрезков - Википедия](https://ru.wikipedia.org/wiki/Дерево_отрезков)
[Дерево отрезков. Построение - Викиконспекты](https://neerc.ifmo.ru/wiki/index.php?title=Дерево_отрезков._Построение)
[Дерево отрезков - Алгоритмика](https://algorithmica.org/ru/segtree)
[Дерево отрезков | структуры данных и алгоритмя](https://www.youtube.com/watch?v=LEkEPE_BKQY)
[Густокашин лекция 6](https://drive.google.com/drive/folders/1MFyd-nNpZEfcVqXH8__40RcDHRMkGKvT)

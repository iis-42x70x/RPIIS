...
![Функции проверки имени](\e\RPIIS\sem2\lab2\pictures\pic1.jpg)
...
![parse_set](\e\RPIIS\sem2\lab2\pictures\pic2.jpg)
![parse_element](\e\RPIIS\sem2\lab2\pictures\pic3.jpg)

Функция **find_element** - поиск элементов по значению, используется в обновлении счётчика кратности.

![Функция поиска элемента](\e\RPIIS\sem2\lab2\pictures\pic4.jpg)

Функция **vector<Element> difference** по описанному алгоритму находит разность двух множеств, формируя конечне множество С.

![Функция нахождения разности двух множеств](\e\RPIIS\sem2\lab2\pictures\pic5.jpg)

Функция **void print_set** используется для вывода множеств.

![Функция вывода множества](\e\RPIIS\sem2\lab2\pictures\pic6.jpg)

### Пример работы программы

![](\e\RPIIS\sem2\lab2\pictures\pic7.jpg)

...
int main() {
    ...
    // 5) Если мы до этого дошли — обе строки успешно распарсились.
    //    Выводим уже разобранные множества, сравниваем и считаем симметрическую разность.
    std::cout << "\nРаспознанные множества:" << std::endl;

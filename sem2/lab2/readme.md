...
<img src="image/bulean.svg.png" width="500">
...
* ### Тест №1
  Для множества А={0, {}, A}
![Вывод консоли](image/test1.png)

* ### Тест №2
   Для множества B={1, 2}
![Вывод консоли](image/test2.png)

* ### Тест №3
   Для множества A={15, <1, 2>}
![Вывод консоли](image/test3.png)

* ### Тест №4
   Для множества A={{, wew, *}
![Вывод консоли](image/test4.png)

* ### Google Test 
![Вывод консоли](image/gtest.png)

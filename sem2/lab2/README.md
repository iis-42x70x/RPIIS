...
<p style="front-size: 220px;">Множество</p> – простейшая информационная конструкция и математическая структура,позволяющая рассматривать какие-то объекты как целое, связывая их.
<h4>Элементы множества</h4> – объекты, связываемые некоторым множеством.

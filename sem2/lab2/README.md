...
* SpaceCheck: возвращает true, если символ является пробельным (пробел, перевод строки, табуляция и т.п.).
* DigitCheck: проверяет, является ли символ цифрой.
* LetterCheck: проверяет, является ли символ латинской буквой (регистр не важен).

...
* Строковый элемент (STRING): когда элемент определяется просто как последовательность допустимых символов (латинские буквы, цифры, символ подчёркивания).
* Множество: представлено как вложенная структура и может быть двух типов:
** Неориентированное множество (SET), которое записывается в фигурных скобках { ... }.
** Ориентированное множество (ORSET), которое записывается в угловых скобках < ... >.
  
Каждый SetElement хранит либо строку (strValue), если это простой элемент, либо вектор других SetElement в поле setValue, если элемент – вложенное множество.

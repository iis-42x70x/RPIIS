...
TEST(MyDeathTest, Foo) {
  // This death lab2 uses a compound statement.
  ASSERT_DEATH({
    int n = 5;
    Foo(&n);
...
TEST(MyDeathTest, TestOne) {
  GTEST_FLAG_SET(death_test_style, "threadsafe");
  // This lab2 is run in the "threadsafe" style:
  ASSERT_DEATH(ThisShouldDie(), "");
}

TEST(MyDeathTest, TestTwo) {
  // This lab2 is run in the "fast" style:
  ASSERT_DEATH(ThisShouldDie(), "");
}
```
...
TEST(FooTest, Bar) {
  Subroutine();  // The intended behavior is for the fatal failure
                 // in Subroutine() to abort the entire lab2.
...
class FooTest : public testing::Test {
 protected:
  // Per-lab2-suite set-up.
  // Called before the first lab2 in this lab2 suite.
  ...
  // Per-lab2-suite tear-down.
  // Called after the last lab2 in this lab2 suite.
  // Can be omitted if not needed.
  ...
  // You can define per-lab2 set-up logic as usual.
  void SetUp() override { ... }

  // You can define per-lab2 tear-down logic as usual.
...
class FooTest :
  ...
  // To access the lab2 parameter, call GetParam() from class
  // TestWithParam<T>.
};
...
TEST_P(FooTest, DoesBlah) {
  // Inside a lab2, access the lab2 parameter with the GetParam() method
...
TYPED_TEST(FooTest, DoesBlah) {
  // Inside a lab2, refer to the special name TypeParam to get the type
...
TYPED_TEST_P(FooTest, DoesBlah) {
  // Inside a lab2, refer to TypeParam to get the type parameter.
  TypeParam n = 0;
...
```c++
  // Gets information about the currently running lab2.
  // Do NOT delete the returned object - it's managed by the UnitTest class.
  const testing::TestInfo* const test_info =
      testing::UnitTest::GetInstance()->current_test_info();

  printf("We are in lab2 %s of lab2 suite %s.\n",
         test_info->name(),
